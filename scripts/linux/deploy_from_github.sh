...
set_env_if_missing VECTOR_DECODER_WEB_UI_DEFAULT_HEADLESS false
set_env_if_missing VECTOR_DECODER_WEB_UI_DEFAULT_MAX_WAIT_SECONDS 240
set_env_if_missing VECTOR_DECODER_WEB_UI_DEFAULT_IDLE_SECONDS 6
